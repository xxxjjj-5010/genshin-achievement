...
// ⚠️ 本表刻意保持"原始快照"、只继承不重算：它是旧版站点的第 N 项 → 当时那个 id 的对应关系。
//    所以即使某个 id 后来进了 EXCLUDE_IDS（如 84517），这里也必须继续映射到**它自己**——
//    否则把 711 改指到 84518，用户在那个位置上的旧勾选就会被"平移"到一个真实成就上，凭空多算 1 个。
